...
function love_period_3(DivName, Gass) {
    ...
    var svg = d3.select(DivName)
        ...
        .attr("height", love_period_svg_height + 100)
        .attr("class", "bar_svg")
    ...
    for (var i = 0; i < love_period_group.length; i++) {
        ...
        svg.append("g")
            ...
            .attr("transform", "translate(" + (i *(period_width+8)+love_period_svg_margin+ ", " + (0) + ")"));
        ...
        for (var j = 0; j < love_period_group[i].values.length; j++) {
            ...
            //画circle 手机版
            circle2(".bar_circle_g_" + i, (circle_r / 2) * 0.9, "bar_circle_" + i + "_" + j, colors[ + (i)], colors[8 + (i)])
            // }
